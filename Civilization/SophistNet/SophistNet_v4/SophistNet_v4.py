...
def set_args():
    ...
    parser.add_argument("--model",                                  type = str,         default = "SophistNet_v4")
    ...
    parser.add_argument("--attention_weights",  action = "append",  type = float,       default = [0.1, 0.1, 0.1, 0.1])
...
if __name__ == "__main__":
    ...
    model = SophistNet_v4(args, writer).cuda(args.gpu)
