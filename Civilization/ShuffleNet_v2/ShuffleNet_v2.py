...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(logdir = "../Alexandria/ShuffleNet_v2_batch_size_{}_epoch_{}_time_{}".format(args.batch_size,args.epoch,datetime.now().strftime("%Y_%m_%d_%H_%M_%S")))
    ...
    model = ResNet_18(args, writer).to(torch.device("cuda"))
