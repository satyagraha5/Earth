...
if __name__ == "__main__":
    args = set_args()
    writer = SummaryWriter(log_dir = "../Alexandria/ResNet_18_batch_size_{}_epoch_{}_learning_rate_{}_time_{}".format(args.batch_size,args.epoch,args.learning_rate,datetime.now().strftime("%Y_%m_%d_%H_%M_%S")))
    ...
    model = ResNet_18(args, writer).cuda(args.gpu)
